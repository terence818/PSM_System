...
public class GroceriesFragment extends Fragment {
    ...
    public static GroceriesFragment groceriesFragment;
...
//            i++;
        adapter = new GroceriesAdapter(getActivity(), data, 3, key);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (String key : checked_key) {
                    ref.child(user.getUid()).child("Groceries_List").child(key).child("status").setValue("Checked");
                }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        if (key_Detail.getStatus().equals("Pending")) {
